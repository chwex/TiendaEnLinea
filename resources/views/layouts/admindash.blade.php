...
<head>
  ...
  <title>Admin Dashboard - Games Bond</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-lg"><b>Games</b>Bond</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset("/Imagenes/minilogo.png") }}" class="img-circle" alt="User Image">
        </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <center><strong>Copyright &copy; 2016 <a href="#">Games Bond GG EZPZ</a>.</strong> Todos los Derechos Reservados.<center>
  </footer>
